...
| §20 | Prevent orphaned software-sweep workers | `docs/architecture/sweeps-and-transports.md` | `drivers/base_smu.py`:37, `drivers/base_smu.py`:428, `drivers/base_smu.py`:545, `tests/test_fixed_source_lifecycle.py`:402 +2 more |
...
| §54 | Preserve units explicitly | `docs/rules/05-si-inside.md` | `core/units.py`:2, `core/units.py`:49, `tests/test_docs.py`:366, `tests/test_parameters.py`:15 +5 more |
