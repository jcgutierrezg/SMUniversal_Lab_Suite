...
#: A directory inside the checkout this file lives in - the package
#: directory, from which git finds the repository - which is the tree
#: whose commit the git lookup must ask about. Deliberately not the working directory:
...
def build_commit():
    ...
    from smuniversal_lab_suite.core.provenance import head_commit
