...
class Keithley2611A(BaseSMU):
    ...
    #:
    #: On this instrument it is the offset. By 2026-09-11 the zero
    #: offset on this range had gone from about -18 nA to about -9 nA,
    #: and the crossing moved down one halving with it, to 6.1e-09 A.
    #: The declared ten counts (1.22e-07 A) sits well above both.
    #:
    ...
    # instrument. Trusted since the 2026-09-11 bench session recorded at
    # the two flags below; a disagreement is a verdict either way - see
    # core/readback.py.
    #
