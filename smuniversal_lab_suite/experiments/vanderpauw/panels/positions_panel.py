...
def build_positions_panel(exp, parent):
    ...
    tip(exp, frame,
        ...
        "senses the voltage, set on the switch box. All four positions "
        "are needed: 1 and 2 average into the horizontal resistance, 3 "
        "and 4 into the vertical one, and the sheet resistance needs "
        "both. The diagram above shows the roles for the position "
        "selected here.")
