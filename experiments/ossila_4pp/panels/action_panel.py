...
Why there is no separate OFF button (Wave 3)
--------------------------------------------
...
Review §8 asks for exactly this and states the rule plainly - all
cancelled runs are discarded regardless of progress - so a control that
