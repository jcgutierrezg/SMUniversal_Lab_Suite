...
|---|---|---|---|---|---|---|---|
| GW Instek GSM-20H10 | 210 V | 1.05 A | 14.4 ms at NPLC 0.01 (its declared minimum), +279 ms first read - 19x | hardware | switchable | yes | yes |
| Keithley 2401 | 21 V | 1.05 A | 35.4 ms at NPLC 0.01 (its declared minimum), +90 ms first read - 3x | software | switchable | yes | yes |
| Keithley 2450 | 210 V | 1.05 A | - | software | switchable | no | **no access** |
| Keithley 2611A | 200 V | 1.5 A | 13.6 ms at NPLC 0.001 (its declared minimum), +86 ms first read - 6x | hardware | switchable | yes | yes |
| Keithley 2635B | 200 V | 1.5 A | 12.2 ms at NPLC 0.001 (its declared minimum), +587 ms first read - 48x, the largest in the fleet | software | switchable | yes | yes |
| Keysight B2901A | 210 V | 3.03 A | 5.7 ms at NPLC 0.0004 (its declared minimum, the shortest aperture in the fleet), +164 ms first read - 29x | software | switchable | yes | yes |
