...
> **This driver has changed since it was last checked against the instrument.** The code has changed since the 2026-08-28 checkup. The measurement may be fine; nobody has confirmed it. Run `uv run tools/smu_checkup.py --address <addr>` first.
